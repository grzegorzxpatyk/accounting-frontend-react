            ...
            <div>
                <section>
                    ...
                    <ul>
                        ...
                        <li>
                            sporządzanie ewidencji dla celów rozliczenia podatku
                            od towarów i usług (VAT){' '}
                        </li>
                        <li>
                            prowadzenie ewidencji wyposażenia i ewidencji
                            środków trwałych, wraz z dokonywaniem miesięcznych
                            odpisów amortyzacyjnych i ewentualnym
                        ...
                        <li>
                            ...
                            rozliczanie zwolnień lekarskich, wyliczanie
                            przysługujących urlopów i świadczeń
                        </li>{' '}
                        <li>
                            przygotowanie dokumentacji ZUS związanej z
                            powstaniem i zarejestrowaniem nowej firmy,
                            comiesięczne przekazy elektroniczne deklaracji ZUS,
                            obsługa Klienta przed Zakładem Ubezpieczeń
                            Społecznych
                        </li>{' '}
                        <li>
                            na zlecenie Klienta zajmujemy się tylko sprawami
                            kadrowymi w firmie bez świadczenia usługi księgowej
                        </li>{' '}
                        <li>
